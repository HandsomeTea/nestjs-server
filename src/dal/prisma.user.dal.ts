...
// import { innerAdminId } from './prisma.role.dal';
...
//             where: { id, AND: { id: { not: innerAdminId } } },
//             data: {
//                 ...name ? { name } : {},
//                 ...phone ? { phone } : {},
//                 ...email ? { email } : {},
...
//             where: {
//                 role: { has: roleId }, AND: { id: { not: innerAdminId } }
//             }
//         })
...
//                 await this.user.update({
//                     where: { id: hasRoleUsers[s].id, AND: { id: { not: innerAdminId } } },
//                     data: {
